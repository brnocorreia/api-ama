...
import (
	...
	"github.com/brnocorreia/api-ama/internal/store/pgstore"
...
func NewHandler(q *pgstore.Queries) http.Handler {
	...
	// I will declare all WebSocket routes here
	r.Get("/subscribe/{room_id}", a.handleSubscribe)

	// I will declare all REST API routes here
...
func (h apiHandler) handleCreateRoom(w http.ResponseWriter, r *http.Request) {
	...
	sendJSON(w, ResponseID{ID: roomID.String()})
}
...
func (h apiHandler) handleGetRooms(w http.ResponseWriter, r *http.Request) {
	...
	sendJSON(w, ResponseRooms{Rooms: rooms})
}
...
func (h apiHandler) handleCreateRoomMessage(w http.ResponseWriter, r *http.Request) {
	...
	sendJSON(w, ResponseID{ID: messageID.String()})
...
func (h apiHandler) handleGetRoomMessages(w http.ResponseWriter, r *http.Request) {
	...
	sendJSON(w, ResponseMessages{Messages: messages})
}
...
func (h apiHandler) handleReactToMessage(w http.ResponseWriter, r *http.Request) {
	...
	sendJSON(w, ResponseCount{Count: count})
